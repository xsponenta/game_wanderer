...
class Batyar(Enemy):
    ...
    def __init__(self):
        ...
        super().__init__(
            "Ooooh... it is batyar!!!!",
            "You should be so intelegent to speak with him",
        )
        self.set_conversation("Hey, what are u doing man?")

    def fight(self, item: str):
        inp = input("going for drinks and sigies")
...
class Lotr(Enemy):
    ...
    def __init__(self):
        ...
        self.set_conversation("do u have cigarette?")
...
class Cavalier(Enemy):
    ...
    def __init__(self):
        ...
        super().__init__(
            "he is so elegant",
            "Ohhhh, he is so cuty man",
        )
        self.set_conversation("Let me give tou a hug!")
    ...
    def fight(self, item: str) -> bool:
        ...
        if inp.lower.startswith("y"):
            print("You died")
            return False
        print("Cavalier disgraced himself in front of the girl and ran away.")
        return True
...
class Zbuy(Enemy):
    ...
    def __init__(self):
        ...
        """
        super().__init__(
            'he is dangerous and can beat you',
            'he has a gun',
            )
        self.set_conversation('hey lad, where are u going')

    def fight(self, item: str):
        print(f'You are dead and zbuy glad to have {item}')
        return False
